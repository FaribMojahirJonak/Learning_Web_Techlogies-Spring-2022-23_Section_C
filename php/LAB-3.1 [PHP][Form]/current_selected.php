<html>
    <head>
        <title>Current Selected Form</title>
    </head>
    <body>
        <form method="POST" action="current_selected.php" enctype="">
            <fieldset>
                <legend>Name</legend>
                <input type="text" name="username" value="<?php if(isset($_REQUEST['username'])) echo $_REQUEST['username']; ?>" /> <hr>
            </fieldset>
            ...
            <fieldset>
                ...
                <input type="date" name="birthday" value="<?php if(isset($_REQUEST['birthday'])) echo $_REQUEST['birthday']; ?>" /> <hr>
            </fieldset>
